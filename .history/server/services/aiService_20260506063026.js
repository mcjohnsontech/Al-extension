...
export async function summarizePage({ text, title }) {
  ...
  const requestBody = {
    system_instruction: {
      parts: [
        {
          text: 'Respond ONLY with a valid JSON object (no markdown, no code fences, no extra text) in this exact shape: {"bullets":["...","..."],"insights":["...","..."],"readingTime":number}. Rules: bullets are 4-6 key points under 120 chars. insights are 2-4 observations under 120 chars. readingTime is minutes (integer >= 1).',
        },
      ],
    },
    contents: [
